...
class Controller_Home extends Controller {
    ...
    public function action_index() {
        ...
        $feature_qry = $premium_qry = clone $ads;
        $feature_ads = $feature_qry->where('featured', '>=', Date::unix2mysql())->order_by('featured','DESC')->cached()->find_all();
        $premium_ads = $premium_qry->where('premium', '>=', Date::unix2mysql())->order_by('premium','DESC')->cached()->find_all();
        ...
        $this->template->content = View::factory('pages/home', compact('feature_ads', 'premium_ads', 'categs', 'locats', 'auto_locats', 'user_location'));
    }
