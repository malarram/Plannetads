...
if ($user_location)
    ...
    $spon_ads = $spon_qry->where('sponsored', '>=', Date::unix2mysql())->order_by('sponsored','DESC')->cached()->find_all();
?>
            ...
            <li>
                <div class="uk-panel uk-panel-box">
                    <div class="uk-panel-teaser">
                        <a href="<?= Route::url('ad', array('category' => $ad->category->seoname, 'seotitle' => $ad->seotitle)) ?>"> <img src="<?= $ad_first ?>" alt="<?= HTML::chars($ad->title) ?>"></a>
                    </div>
