...
<div class="row">
    <div class="col-md-8">
	    ...
	    <div class="panel-heading"><?=__("Image configuration")?></div>
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <?= FORM::label($forms['watermark']['id'], __('Watermark'), array('class'=>'control-label col-sm-4', 'for'=>$forms['watermark']['id']))?>
                        <div class="col-sm-8">
