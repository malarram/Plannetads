    ...
    <div class="col-md-8">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        <?= FORM::label($forms['maintenance']['id'], __("Maintenance Mode"), array('class'=>'control-label col-sm-4', 'for'=>$forms['maintenance']['id']))?>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <?= FORM::label($forms['moderation']['id'], __('Moderation'), array('class'=>'control-label col-sm-4', 'for'=>$forms['moderation']['id']))?>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group hidden">
                        <?= FORM::label($forms['landing_page']['id'], __('Landing page'), array('class'=>'control-label col-sm-4', 'for'=>$forms['landing_page']['id']))?>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group hidden">
                            <?= FORM::label($forms['api_key']['id'], __('API Key'), array('class'=>'control-label col-sm-4', 'for'=>$forms['api_key']['id']))?>
                            <div class="col-sm-8">
                    ...
                    <div class="form-group hidden">
                        <?= FORM::label($forms['alert_terms']['id'], __('Accept Terms Alert'), array('class'=>'control-label col-sm-4', 'for'=>$forms['alert_terms']['id']))?>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group hidden">
                        <?= FORM::label($forms['gcm_apikey']['id'], __('GCM API Key'), array('class'=>'control-label col-sm-4', 'for'=>$forms['gcm_apikey']['id']))?>
                        <div class="col-sm-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        <?= FORM::label($forms['number_format']['id'], __('Money format'), array('class'=>'control-label col-sm-4','for'=>$forms['number_format']['id']))?>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <?= FORM::label($forms['date_format']['id'], __('Date format'), array('class'=>'control-label col-sm-4', 'for'=>$forms['date_format']['id']))?>
                        <div class="col-sm-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        <?= FORM::label($forms['blog_disqus']['id'], __('Disqus for blog'), array('class'=>'control-label col-sm-4', 'for'=>$forms['blog_disqus']['id']))?>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <?= FORM::label($forms['faq_disqus']['id'], __('Disqus for FAQ'), array('class'=>'control-label col-sm-4', 'for'=>$forms['faq_disqus']['id']))?>
                        <div class="col-sm-8">
