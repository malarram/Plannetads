        ...
        <div class="uk-block">
            ...
            <div class="uk-grid uk-grid-collapse">
                <div class="uk-width-medium-1-4 uk-width-small-1-1">
                    <select name="category" id="category" data-placeholder="<?php echo __('Category') ?>" class="uk-form chosen-select-no-search search-category">
                ...
                <div class="uk-width-medium-4-10 uk-width-small-1-1 search-keyword">
